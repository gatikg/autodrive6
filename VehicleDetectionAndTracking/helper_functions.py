...
def get_hog_features(img, orient=9, pix_per_cell=8, cell_per_block=2,
                     transform_sqrt=False, visualize=False, feature_vec=True):
    '''
    ...
    :param visualize(boolean): Boolean flag to turn HOG visualization on/off
...
def single_img_features(img, color_space='RGB', spatial_size=(32, 32),
    ...
    feature_img = convert_color(
        img, cspace=color_space)  # returns in 0-255 range
