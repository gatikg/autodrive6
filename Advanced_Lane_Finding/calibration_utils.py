...
def lazy_calibration(func):
    ...
    """
    calibration_cache = 'G:\self-driving-car-master\project_4_advanced_lane_finding\camera_cal\calibration_data.pickle'
...
def calibrate_camera(calib_images_dir, verbose=False):
    ...
    assert path.exists(
        calib_images_dir), '"{}" must exist and contain calibration images.'.format(calib_images_dir)
